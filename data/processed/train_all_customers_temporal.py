...
class TemporalConfig:
    ...
    SHORT = {
        'name': 'short',
        'window_days': 28,      # 4 semanas de historial
        'forecast_days': 14,    # Predecir próximas 2 semanas
        'lstm_units': [64, 32],
        'epochs': 80,
        'batch_size': 32
    }
    ...
    MEDIUM = {
        'name': 'medium',
        'window_days': 90,      # 3 meses de historial
        'forecast_days': 30,    # Predecir próximo mes
        'lstm_units': [128, 64],
        'epochs': 100,
        'batch_size': 64
    }
    ...
    LONG = {
        'name': 'long',
        'window_days': 180,     # 6 meses de historial
        'forecast_days': 60,    # Predecir próximos 2 meses
