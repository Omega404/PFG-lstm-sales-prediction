...
class ProductTemporalConfig:
    """Configuración unificada para productos - 50 EPOCHS para comparación"""
    ...
    SHORT = {
        ...
        'lstm_units': [64, 32],
        'epochs': 50,           # ← Aumentado de 20 a 50
        'batch_size': 32
    }
    ...
    MEDIUM = {
        ...
        'lstm_units': [128, 64],
        'epochs': 50,           # ← Aumentado de 30 a 50
        'batch_size': 64
    }
    ...
    LONG = {
        ...
        'epochs': 50,           # ← Aumentado de 40 a 50
        'batch_size': 64
    }
...
class ProductTemporalAnalyzer:
    ...
    def train_horizon_model(self, horizon_config, platform="local", script_version="v1"):
        ...
        if MLFLOW_AVAILABLE:
            mlflow.set_experiment("products_temporal_50epochs")  # ← Experimento diferente
            run_name = f"products_{horizon_name}_{platform}_50ep"
            ...
            mlflow.log_params({
                "model_type": "products",
                "version": "50_epochs",  # ← Identificador de versión
                "horizon": horizon_name,
                "window_days": horizon_config['window_days'],
                "forecast_days": horizon_config['forecast_days'],
                "lstm_units": str(horizon_config['lstm_units']),
                "epochs_config": horizon_config['epochs'],  # Será 50 para todos
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Entrenar modelos LSTM de productos - 50 EPOCHS')
    parser.add_argument('--data', default='data/processed/online_retail_2.xlsx',
                        help='Ruta al dataset')
    parser.add_argument('--output', default='models/temporal/products_50epochs',
